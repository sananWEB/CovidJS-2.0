...
const [select,setSelect] = useState(150);
  ...
  return (
    <React.Fragment>
      ...
      <Typography variant="h4"  style={{color:"#0ABDE3",fontWeight:"bold"}}>COVID-19 is a disease caused by a new strain of coronavirus. ‘CO’ stands for corona, ‘VI’ for virus, and ‘D’ for disease.</Typography>
     <Typography variant="h4" style={{paddingTop:'5%',fontWeight:"bold"}}>Choose a Country</Typography>
